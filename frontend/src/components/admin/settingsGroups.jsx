...
export const SETTINGS_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "owner_whatsapp", type: "text", label: "Owner's WhatsApp number",
        hint: "Approval codes and alerts go here. Leave blank to use the on-screen inbox only." },
      { key: "owner_email", type: "text", label: "Owner's email",
        hint: "Fallback for owner alerts when WhatsApp is unavailable." },
